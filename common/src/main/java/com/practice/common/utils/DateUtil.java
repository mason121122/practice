...
public class DateUtil {
     ...
     */
    public static Date getNowDateShort(Date now) {
        String dateString = formatter.format(now);
        ParsePosition pos = new ParsePosition(8);
        Date currentTime_2 = formatter.parse(dateString, pos);
        return currentTime_2;
     ...
     */
    public static String getStringAllDate(Date now) {
     ...
     */
    public static String getStringDateShort(Date now) {
        String dateString = formatter.format(now);
        return dateString;
    }
     ...
     * @return
     */
    public static String getTimeShort(Date now) {
