...
@WebService(name = "ServerServiceDemo", targetNamespace = "http://soap.web.practice.com",
        endpointInterface = "com.practice.web.soap.ServerServiceDemo")
public class ServerServiceDemoImpl implements ServerServiceDemo {
    /**
     *
     * postman请求xml
     * <?xml version='1.0' encoding='utf-8'?>
     * <soapenv:Envelope xmlns:soapenv="http://schemas.xmlsoap.org/soap/envelope/" xmlns:ns1="http://soap.web.practice.com"><!-- 此处即为命名空间，即targetNamespace -->
     * 	<soapenv:Header>
     * 		<ns1:requestHead>
     * 		    <standardVersionCode></standardVersionCode>
     * 		    <maxRecord>1</maxRecord>
     * 		    <transRefGUID>2</transRefGUID>
     * 		    <transactionCode>3</transactionCode>
     * 		</ns1:requestHead>
     *   </soapenv:Header>
     * 	<soapenv:Body>
     * 		<ns1:emrService>	<!-- 调用方法名称 -->
     * 			<payeeInformation>
     * 			<customerType>1111</customerType>
     * 			<customerNature>2222</customerNature>
     * 			<bankType>222</bankType>
     * 			</payeeInformation>
     * 		</ns1:emrService>
     * 	</soapenv:Body>
     * </soapenv:Envelope>
     */
    @Override
    public String emrService(RequestHead requestHead,PayeeInformation payeeInformation) {
        log.info(JSONObject.toJSONString(requestHead));
        log.info(JSONObject.toJSONString(payeeInformation));
        return "调用成功";
    }
}
